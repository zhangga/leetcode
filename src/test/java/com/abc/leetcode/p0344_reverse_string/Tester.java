/**
 * Leetcode - p0344_reverse_string
 */
package com.abc.leetcode.p0344_reverse_string;
...
public class Tester {
    ...
    public Tester(char[] para1, Object para2, char[] expected) {
