...
//        solution = new Solution1();
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
             {1,1,1},     // test case 1 (init parameters below: {para1, para2, expected})
    ...
    public void test() {
        ...
        solution.addNum(3);
         ...
         Object actual = solution.findMedian();
         assertThat(actual, is(equalTo(2)));

        solution.addNum(4);
        Object actua2 = solution.findMedian();
        assertThat(actua2, is(equalTo(2.5)));
