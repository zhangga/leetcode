/**
 * Leetcode - p0350_intersection_of_two_arrays_ii
 */
package com.abc.leetcode.p0350_intersection_of_two_arrays_ii;
...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        int[] para1 = new int[]{1,2,2,1};
        int[] para2 = new int[]{2,2};
        int[] expected = new int[]{2,2};
        return Arrays.asList(new Object[][]{
             {para1, para2, expected},     // test case 1 (init parameters below: {para1, para2, expected})
    ...
    public void test() {
         ...
         Object actual = solution.intersect(para1, para2);
