...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        int[] para1 = new int[]{1,2,3,1};
        int k = 3;
        int t = 0;
        boolean expected = true;
        return Arrays.asList(new Object[][]{
             {para1, k, t, expected},     // test case 1 (init parameters below: {para1, para2, expected})
    ...
    public Tester(int[] para1, int para2, int para3, boolean expected) {
    ...
    public void test() {
         ...
         Object actual = solution.containsNearbyAlmostDuplicate(para1, para2, para3);
