...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
             {"aa", "a", false},     // test case 1 (init parameters below: {para1, para2, expected})
             {"aa", "a*", true},     // test case 2 (init parameters below: {para1, para2, expected})
    ...
    public void test() {
         ...
         Object actual = solution.isMatch(para1, para2);
