...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
             {6, true},     // test case 1 (init parameters below: {para1, para2, expected})
             {14, false},     // test case 2 (init parameters below: {para1, para2, expected})
             {-2147483648, false}      // test case 3 (init parameters below: {para1, para2, expected})
        });
    }
    ...
    public void test() {
         ...
         Object actual = solution.isUgly(para1);
