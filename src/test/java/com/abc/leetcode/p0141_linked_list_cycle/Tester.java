...
//        solution = new Solution1();
    ...
    public static Collection<Object[]> testcases() {
        ...
        return Arrays.asList(new Object[][]{
             {head1_1, true},     // test case 1 (init parameters below: {para1, para2, expected})
             {head2_1, true},     // test case 2 (init parameters below: {para1, para2, expected})
             {head3_1, false}      // test case 3 (init parameters below: {para1, para2, expected})
        });
    }
     ...
     */
     private ListNode head;                       // parameter 1
...
//         this.para2 = para2;
    ...
    public void test() {
         ...
         Object actual = solution.hasCycle(head);
