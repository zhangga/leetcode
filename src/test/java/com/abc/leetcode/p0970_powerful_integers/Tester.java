...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        ...
        return Arrays.asList(new Object[][]{
             {2, 3, 10, list},     // test case 1 (init parameters below: {para1, para2, expected})
    ...
    public Tester(int para1, int para2, int para3, List<Integer> expected) {
    ...
    public void test() {
         ...
         Object actual = solution.powerfulIntegers(para1, para2, para3);
