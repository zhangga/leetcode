...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        ...
        return Arrays.asList(new Object[][]{
             {prices1, expected1},     // test case 1 (init parameters below: {para1, para2, expected})
             {prices2, expected2},     // test case 2 (init parameters below: {para1, para2, expected})
    ...
    public void test() {
         ...
         Object actual = solution.maxProfit(para1);
