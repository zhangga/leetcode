...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        ...
        return Arrays.asList(new Object[][]{
             {inorder, postorder, root},     // test case 1 (init parameters below: {para1, para2, expected})
    ...
    public Tester(int[] para1, int[] para2, TreeNode expected) {
    ...
    public void test() {
         ...
         Object actual = solution.buildTree(para1, para2);
