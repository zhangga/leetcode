/**
 * Leetcode - p0221_maximal_square
 */
package com.abc.leetcode.p0221_maximal_square;
...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        ...
        return Arrays.asList(new Object[][]{
             {matrix, output},     // test case 1 (init parameters below: {para1, para2, expected})
    ...
    public Tester(char[][] para1, int expected) {
    ...
    public void test() {
         ...
         Object actual = solution.maximalSquare(para1);
