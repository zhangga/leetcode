...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        ...
        return Arrays.asList(new Object[][]{
             {para1, 3, true},     // test case 1 (init parameters below: {para1, para2, expected})
    ...
    public Tester(int[] para1, int para2, boolean expected) {
    ...
    public void test() {
         ...
         Object actual = solution.containsNearbyDuplicate(para1, para2);
