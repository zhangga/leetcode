...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        ...
        return Arrays.asList(new Object[][]{
             {root, expected},     // test case 1 (init parameters below: {para1, para2, expected})
    ...
    public Tester(TreeNode para1, List<Integer> expected) {
    ...
    public void test() {
         ...
         Object actual = solution.rightSideView(para1);
