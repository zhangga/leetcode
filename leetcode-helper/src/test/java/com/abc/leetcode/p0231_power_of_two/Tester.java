...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
             {1, true},     // test case 1 (init parameters below: {para1, para2, expected})
             {16, true},     // test case 2 (init parameters below: {para1, para2, expected})
             {218, false}      // test case 3 (init parameters below: {para1, para2, expected})
        });
    }
    ...
    public void test() {
         ...
         Object actual = solution.isPowerOfTwo(para1);
