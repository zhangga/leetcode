...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
             {10, 3, 3},     // test case 1 (init parameters below: {para1, para2, expected})
             {7, -3, -2},     // test case 2 (init parameters below: {para1, para2, expected})
    ...
    public void test() {
         ...
         Object actual = solution.divide((int)para1, (int)para2);
