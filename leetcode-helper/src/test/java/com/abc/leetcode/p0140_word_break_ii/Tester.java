...
//        solution = new Solution1();
    ...
    public static Collection<Object[]> testcases() {
        ...
        return Arrays.asList(new Object[][]{
             {s, wordDict, expected},     // test case 1 (init parameters below: {para1, para2, expected})
     ...
     */
     ...
     private List<String> para2;                       // parameter 2
     private List<String> expected;                    // parameter 3 (expected answer)

    /** This constructor must be provided to run parameterized test. */
    public Tester(String para1, List<String> para2, List<String> expected) {
    ...
    public void test() {
         ...
         Object actual = solution.wordBreak(para1, para2);
