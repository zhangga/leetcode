...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
             {3, 0},     // test case 1 (init parameters below: {para1, para2, expected})
             {5, 1},     // test case 2 (init parameters below: {para1, para2, expected})
    ...
    public void test() {
         ...
         Object actual = solution.trailingZeroes(para1);
