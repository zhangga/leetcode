...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
             {3, ""},     // test case 1 (init parameters below: {para1, para2, expected})
    ...
    public Tester(Object para1, Object expected) {
    ...
    public void test() {
         ...
         Object actual = solution.generateParenthesis((Integer) para1);
