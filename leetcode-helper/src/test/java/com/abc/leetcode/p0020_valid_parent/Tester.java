...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
             {"{[]}", true},     // test case 1 (init parameters below: {para1, para2, expected})
             {"([)]", false},     // test case 2 (init parameters below: {para1, para2, expected})
    ...
    public void test() {
         ...
         Object actual = solution.isValid(para1);
