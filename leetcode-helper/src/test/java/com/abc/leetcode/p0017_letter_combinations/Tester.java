...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        ...
        return Arrays.asList(new Object[][]{
             {"23", expected},     // test case 1 (init parameters below: {para1, para2, expected})
    ...
    public Tester(String para1, List<String> expected) {
    ...
    public void test() {
         ...
         Object actual = solution.letterCombinations(para1);
