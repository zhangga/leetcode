...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
             {"Z", 26},     // test case 1 (init parameters below: {para1, para2, expected})
             {"AB", 28},     // test case 2 (init parameters below: {para1, para2, expected})
    ...
    public void test() {
         ...
         Object actual = solution.titleToNumber(para1);
