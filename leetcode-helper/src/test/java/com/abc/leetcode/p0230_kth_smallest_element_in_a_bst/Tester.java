...
//        solution = new Solution1();
    ...
    public static Collection<Object[]> testcases() {
        ...
        return Arrays.asList(new Object[][]{
             {root, 1, 1},     // test case 1 (init parameters below: {para1, para2, expected})
    ...
    public Tester(TreeNode para1, int para2, int expected) {
    ...
    public void test() {
         ...
         Object actual = solution.kthSmallest(para1, para2);
