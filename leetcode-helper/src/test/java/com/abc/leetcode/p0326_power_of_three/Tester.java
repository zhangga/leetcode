...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        return Arrays.asList(new Object[][]{
             {0, false},     // test case 1 (init parameters below: {para1, para2, expected})
             {27, true},     // test case 2 (init parameters below: {para1, para2, expected})
             {45, false}      // test case 3 (init parameters below: {para1, para2, expected})
        });
    }
    ...
    public void test() {
         ...
         Object actual = solution.isPowerOfThree(para1);
