...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        ...
        ListNode ret3 = new ListNode(3);
        ListNode ret4 = new ListNode(4);
        ListNode ret5 = new ListNode(5);
        ListNode ret6 = new ListNode(6);
        ListNode ret7 = new ListNode(7);
        ListNode ret8 = new ListNode(8);
        ret3.next = ret2;
        ret2.next = ret1;
        ret1.next = ret6;
        ret6.next = ret5;
        ...
        return Arrays.asList(new Object[][]{
             {node1, 3, ret3},     // test case 1 (init parameters below: {para1, para2, expected})
    ...
    public void test() {
         ...
         Object actual = solution.reverseKGroup((ListNode) para1, (int)para2);
